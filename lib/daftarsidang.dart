...
class PendaftaranSidangPageFinalV26 extends StatefulWidget {
  const PendaftaranSidangPageFinalV26({super.key});

  @override
  State<PendaftaranSidangPageFinalV26> createState() =>
      _PendaftaranSidangPageFinalV26State();
}

class _PendaftaranSidangPageFinalV26State
    extends State<PendaftaranSidangPageFinalV26> {
  ...
  static const Color bottomNavBorderColor = Color(0xFFB3E5FC);
              ...
              child: Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: lightBlueBg, width: 1.5), // Border biru muda
                    boxShadow: [
                      BoxShadow(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      const SizedBox(width: 30), // Jarak antar ikon
                      // Ikon Toga
                      _buildBottomNavItem(
                          Icons.school_outlined, Icons.school, 1),
                      const SizedBox(width: 30), // Jarak antar ikon
                      // Ikon Person
                      _buildBottomNavItem(
                          Icons.person_outlined, Icons.person, 2),
                    ],
                  ),
                ),
              ),
...
void main() {
  runApp(const MaterialApp(
    title: 'Aplikasi Sidang (Final V26)',
    home: PendaftaranSidangPageFinalV26(),
